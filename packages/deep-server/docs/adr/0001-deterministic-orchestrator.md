...
- Grilling, the only multi-turn Step, records its progress in the Grilling Transcript Artifact, which is kept after the GP is written and then ignored for advancing. It is an Artifact like any other, not a separate state file.
